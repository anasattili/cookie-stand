...
for (var i = 0; i < cities.length; i++) {
    cities[i].getCustomerPerHour(cities[i].minRes, cities[i].maxRes);
    cities[i].render();
    //console.log(cities[i].avgRes);
    //} //  

}
console.log(seattle.ranNum);
